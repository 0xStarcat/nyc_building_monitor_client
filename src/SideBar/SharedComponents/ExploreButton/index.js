...
import { SCOPE_CENSUS_TRACTS, SCOPE_NEIGHBORHOODS, SIDEBAR_VIEW_SELECTED_OBJECT } from '../../../Store/AppState/actions'
...
const ExploreButton = props => {
  ...
  const showButton = () => {
    return (
      ...
      props.appState.sidebarView === SIDEBAR_VIEW_SELECTED_OBJECT &&
