...
import { SCOPE_CENSUS_TRACTS, SIDEBAR_VIEW_MAP_DETAILS_MENU } from '../../../Store/AppState/actions'
  ...
  describe('on click', () => {
    ...
    describe('when not disabled', () => {
      ...
      describe('if viewSwitch prop', () => {
        const dispatchFn = sinon.spy()
        const wrapper = shallow(
          <SwitchViewButton disabled={false} dispatch={dispatchFn} viewSwitch={SIDEBAR_VIEW_MAP_DETAILS_MENU} />
        )
        wrapper.find('.switch-view-button').simulate('click')
        it('calls the dispatch method once', () => {
          expect(dispatchFn.calledOnce).toEqual(true)
      ...
      describe('if scopeSwitch and viewSwitch prop', () => {
        ...
        const wrapper = shallow(
          <SwitchViewButton
            ...
            viewSwitch={SIDEBAR_VIEW_MAP_DETAILS_MENU}
          />
        )
        wrapper.find('.switch-view-button').simulate('click')
