...
export const selectNewSelectedCTObject = event => dispatch => {
  if ((store.getState().censusTracts.selectedObject || {}).id === event.id) return null
  dispatch(updateSelectedCTObject(event))
