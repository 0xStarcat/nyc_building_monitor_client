...
import { HomeIcon, AboutIcon, StoryIcon, SupportIcon } from '../../SharedStyles/icons'
  ...
  return (
    <div className="link-menu">
      <div className="menu-section">
        <AppLink className="menu-link" href="/" active={props.router.location.pathname === '/'}>
          <IconRow icon={HomeIcon}>NYC Building Monitor</IconRow>
        </AppLink>
        <AppLink className="menu-link" href="/about" active={props.router.location.pathname === '/about'}>
